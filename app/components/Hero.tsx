...
const Hero = () => {
  return (
  <section 
    className='max-container padding-container py-10 pb-32 md:gap lg:py-20 xl:flex-row flex flex-col gap-20 '
    >
      ...
      <p className='regular-16 mt-6 text-gray-30 xl:max-x-[520px]'>
